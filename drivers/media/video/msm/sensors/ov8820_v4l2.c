...
#endif
#if 0//def CONFIG_OV8820_ACT//CONFIG_PANTECH_CAMERA_AF_OFF_STEP
...
#if 1//F_1080P //wsyang_temp//F_PANTECH_CAMERA_1080P_PREVIEW
	{2, CSI_RESERVED_DATA_0, CSI_DECODE_8BIT},//CSI_RESERVED_DATA
#endif
};
...
//		.lane_assign = 0xe4,
		.lane_cnt = 2,
		.lut_params = {
			.num_cid = ARRAY_SIZE(ov8820_cid_cfg),//2,
...
//    mdelay(1);
    ...
    pr_err(" msm_camio_clk_rate_set E\n");
    //msm_camio_clk_rate_set(24000000);
    pr_err(" msm_camio_clk_rate_set X\n");
    mdelay(1);
...
#if 0//def CONFIG_OV8820_ACT// 1//CONFIG_PANTECH_CAMERA_AF_OFF_STEP
