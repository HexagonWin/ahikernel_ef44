...
#define YACD5C1SBDBC_PREVIEW_FPS_PARM 45//42//57//54//
#endif
#if (defined(CONFIG_MACH_MSM8960_MAGNUS) || defined(CONFIG_MACH_MSM8960_OSCAR) || defined(CONFIG_MACH_MSM8960_EF44S))
...
#if defined(CONFIG_MACH_MSM8960_OSCAR)//coninuous => continuous. Isn't this right?
